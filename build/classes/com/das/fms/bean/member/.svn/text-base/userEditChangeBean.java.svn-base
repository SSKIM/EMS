...
public class userEditChangeBean extends CommandServlet {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		try {
			...
			String passwordNew   = (String)CommonUtil.getParameter(request, "PASSWORD_NEW");
			...
			param.add(Endec.encryptData(passwordNew));
