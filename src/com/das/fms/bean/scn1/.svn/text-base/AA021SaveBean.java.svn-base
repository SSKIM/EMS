...
public class AA021SaveBean extends CommandServlet {
	private final Logger log = Logger.getLogger(this.getClass());

	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		try {
			// 1. get parameter
			String jrnlNo      = (String)((Map)(((Map)request.getAttribute("RESULT_SET"))).get("dataPK")).get("JRNL_NO");
			String cancelReaon = (String)CommonUtil.getParameter(request, "CANCEL_REASON");
			...
			request.setAttribute("JRNL_NO_NEW", jrnlNo);
