...
document.write('<OBJECT ID="RexCtl" CLASSID="CLSID:9E1F4A27-7EB0-4210-98D8-1CCF6671F483" CODEBASE="./cab/Rexpert25ViewerFull.cab#version=2,5,1,81" WIDTH="100%" HEIGHT="100%">');
document.write('<PARAM NAME="ToolBarVisible" VALUE="true">');
document.write('<PARAM NAME="StatusBarVisible" VALUE="true">');
...
document.write('<PARAM NAME="BackColor" VALUE="8421504">');
document.write('</OBJECT>');

document.write('<!-- msxml4.cab install -->');
document.write('<OBJECT ID="MSXML4"    CLASSID="CLSID:88d969c0-f192-11d4-a65f-0040963251e5" CODEBASE="./cab/msxml4.cab#version=4,20,9848,0"   TYPE="application/x-oleobject" STYLE="DISPLAY: NONE"></OBJECT>');
...
document.write('<OBJECT ID="Excel"     CLASSID="CLSID:5409E65D-2BF2-4681-B508-1FB590A616C4" CODEBASE="./cab/ExcelExport.cab#version=4,1,3,94" TYPE="application/x-oleobject" STYLE="DISPLAY: NONE"></OBJECT>');
...
//document.write('<OBJECT ID="Chart1"    CLASSID="CLSID:FAB9B41C-87D6-474D-AB7E-F07D78F2422E" CODEBASE="./cab/teechart7.cab#version=7,0,0,5"    TYPE="application/x-oleobject" STYLE="DISPLAY: NONE"></OBJECT>');
