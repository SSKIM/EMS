...
<%@ page import="java.util.Map,java.util.HashMap,java.util.List,java.util.ArrayList,java.io.OutputStream,java.io.IOException"%>
<%@ page import="net.sf.jasperreports.view.JasperViewer,net.sf.jasperreports.engine.*,net.sf.jasperreports.engine.export.*,net.sf.jasperreports.engine.base.JRBasePrintPage" %>
...
<%
	...
	String filePath  = "D:/project/dfs/workspace/dfs/WebContent/report/CR010.rex";
