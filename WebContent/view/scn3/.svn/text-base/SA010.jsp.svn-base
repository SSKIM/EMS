...
<%
	...
	Map fuelUnitPrice = null, vatRate = null;
	List expsType = null, payMethod = null, evidList = null, deptList = null, chnlList = null, asstList = null, cardList = null, vndrList = null, emplList = null;
	...
	if(resultSet!=null) {
		...
		vndrList      = (List)resultSet.get("VNDR_LIST");
...
<jsp:setProperty name="cboS_ExpsType"  property="dataSource" value="<%=expsType%>"/>
...
<jsp:useBean id="cboVndr" class="com.mindtree.framework.control.ComboBox" scope="page"/>
<jsp:setProperty name="cboVndr" property="dataSource" value="<%=vndrList%>"/>
	...
	<head>
		...
		<script type="text/javascript">
			...
			<%if(!CommonUtil.nullOrEmpty(fuelUnitPrice)) {%>
				...
				fuelAcctNo    = "<%=fuelUnitPrice.get("ETC2")%>";
			<%}%>
			var vatRate = 0;
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/view/scn3/SA010.js"></script>
	...
	<body>
		...
		<table class="searchTable" id="searchTable1">
			<tr>
				<th>템플릿명</th>
				<td colspan=3>
					<input type="text" id="S_TPLT_NAME" style="width:99%"/>
				</td>
			</tr>
			<tr>
				<th style="width:15%">증빙구분</th>
				<td style="width:35%">
					<jsp:setProperty name="cboS_EvidType" property="id" value="S_EVID_TYPE"/>
					<jsp:setProperty name="cboS_EvidType" property="isBlank" value="true"/>
					<jsp:getProperty name="cboS_EvidType" property="bindData" />
				</td>
				<th style="width:15%">비용구분</th>
				<td style="width:35%">
		...
		<div class="main" style="margin-top:3px" id="divMain">
			<table class="dataTable" id="dataTable" style="width:1400px">
				<colgroup>
					<col width=40><col width="120"/><col width=80><col width=120><col width=140><col width=100><col width=160><col width=120><col width=120><col/>
				</colgroup>
				<thead>
					<tr>
						<th>순번</th><th>템플릿명</th><th>거래일자</th><th>증빙구분</th><th>비용구분</th><th>금액</th><th>거래처</th><th>지급예정일자</th><th>지급방법</th><th>비고</th>
					</tr>
				</thead>
				<tbody>
		...
		<input type="hidden" id="TPLT_ID" name="TPLT_ID"/>
		...
		<div id="evidTabs">
			<table class="tabTable" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td class="button">
						<input type="button" id="btnJrnlHist" name="btnJrnlHist" value="전표이력" width="48px" height="24px" class="command">
			...
			<div id="tab-1" class="tabs-selected">
				<table class="formTable" id="fromTable1">
					<tr>
						<th id="lblTPLT_NAME">템플릿 명</th>
						<td colspan=10>
							<input type="text" id="TPLT_NAME" name="TPLT_NAME" style="width:99%"/>
						</td>
					</tr>					
					<tr>
						...
						<td style="width:30%" colspan="3">
							...
							<div id="divVENDOR_CODE3">
								...
								<input type="text" id="VENDOR_CODE3" name="VENDOR_CODE" style="width:60px" maxlength="7"/>
								<input type="text" id="VENDOR_NAME3" name="VENDOR_NAME" style="width:100px" maxlength="40"/>
				...
				<table id="deptForm1" style="width:100%">
					<thead>
						<tr>
							<td>
				...
				<div class="main" style="height:70px">
					<table class="dataTable" id="deptTable1" style="width:2000px">
						<colgroup>
							<col width=100><col width=200><col width=100><col width=200><col width=100><col width=200><col width=100>
						</colgroup>
						<thead>
							<tr>
								<th>금액</th><th class=hidden>부서코드</th><th>부서명</th><th class=hidden>채널코드</th><th>채널명</th><th class=hidden>자산코드</th><th>자산명</th>
							</tr>
						</thead>
						<tbody>
			...
			<div id="tab-6">
				<table class="formTable" id="fromTable2">
					<tr>
						<th>템플릿 명</th>
						<td colspan=7>
							<input type="text" id="TPLT_NAME2" name="TPLT_NAME" style="width:99%"/>
						</td>
					</tr>
					<tr>
						...
						<td style="width:80px">
							<input type="text" id="DEBIT_TOTAL2" name="DEBIT_TOTAL" class="labelLine number" maxlength="18" style="width:99%"/>
						</td>
					</tr>
					<tr>
						...
						<td style="width:80px">
							<input type="text" id="CREDIT_TOTAL2" name="CREDIT_TOTAL" class="labelLine number" maxlength="18" style="width:99%"/>
						</td>
					</tr>
				</table>
					...
					<thead>
						<tr>
							<td>
								...
								<input type="text" id="ACCT_CODE2" name="ACCT_CODE" style="width:60px" maxlength="7"/><input type="text" id="ACCT_NAME2" name="ACCT_NAME" style="width:200px" maxlength="40"/>
				...
				<div class="main" style="height:141px">
