	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$("#POSTING_PERIOD").val("<%=postingPeriod.get("ETC1")%>");
				// GET PARAMETER
			...
			function Save() {
				...
				var action = "scn1.do?method=AB041Save";
...
//						alert(xhr.responseText); //for debuging 
	...
	<body style="margin: 0px 5px 0px 5px">
		<table class="titleTable" id="titleTable">
			<tr>
				<td><img src="./theme/default/image/title/<%=screenId%>.gif" alt="" /> <b>- [<%=screenId%>]</b></td>
			</tr>
		</table>
		<form id="formData" name="formData" method="post">
		<table class="searchTable" style="height:270px">
			<tr>
				<th style="width:25%" id="lblPOSTING_PERIOD">Posting 기간</th>
				<td style="width:75%" colspan="3">
					<input type="text" id="POSTING_PERIOD" style="width:70px;text-align:center"/>
					<span class="" id="S_ACCOUNT_NO"></span>
				</td>
			</tr>
			<tr>
				<th style="width:25%" id="lblJRNL_NO">SS 전표번호</th>
				<td>
					<span id="SS_JRNL_NO"></span>
				</td>
				<th style="width:25%" id="lblJRNL_NO">SS 전표상태</th>
				<td>
			...
			<tr style="height:35px">
				<td colspan="4" align=center>
					<input type="button" id="btnSave" name="btnSave" value="저장" width="48px" height="24px" class="command">
					<input type="button" id="btnCancel" name="btnCancel" value="취소" width="48px" height="24px" class="command">
				</td>
			</tr>
			<tr>
				<td colspan="4" valign=top>
					<div id="output" style="display:block;overflow:auto;height:175px;margin-top:2px">
