...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/view/scn1/AB023.js"></script>
...
<div id="expsType1">
				<table class="formTable" id="fromTable1">
					...
					<tr>
						...
						<td colspan="5">
							<input type="text" id="REMARK" name="REMARK" style="width:99%" maxlength="40"/>
						</td>
						<th style="width:12%" id="lblBUSI_NO">사업자등록번호</th>
...
<div id="expsType2">
				<table class="formTable" id="fromTable2">
					<tr>
						...
						<td style="width:80px">
							<input type="text" id="DEBIT_TOTAL2" name="DEBIT_TOTAL" class="labelLine number" maxlength="18" style="width:80px"/>
						</td>
					</tr>
					<tr>
						<th id="lblREMARK6">적요</th>
						<td colspan="5">
							<input type="text" id="REMARK6" name="REMARK" style="width:99%" maxlength="40"/>
						</td>
						<th id="lblCREDIT_TOTAL2">대변 합계:</th>
						<td style="width:80px">
							<input type="text" id="CREDIT_TOTAL2" name="CREDIT_TOTAL" class="labelLine number" maxlength="18" style="width:80px"/>
						</td>
					</tr>
				</table>
				<div style="height:391px;margin-top:2px">
					<table class="dataTable" id="deptTable2">
						<colgroup>
							<col width=40><col width=60><col width=140><col width=60><col width=60><col width=60><col width=100><col width=60><col width=100>
						</colgroup>
						<thead>
							<tr>
								<th>순번</th><th>계정과목</th><th>계정과목명</th><th>차대금액</th><th>대변금액</th><th class=hidden>부서코드</th><th>부서명</th><th class=hidden>채널코드</th><th>채널명</th><th class=hidden>차대구분</th>
							</tr>
						</thead>
						<tbody></tbody>
					</table>
					...
					<table style="width:100%">
						<thead>
							<tr>
								...
								<td style="width:30%">
									<input type="text" id="DEBIT_TOTAL3" name="DEBIT_TOTAL" class="labelLine number"/>
								</td>
								<th id="lblCREDIT_TOTAL3">대변 합계:</th>
								<td style="width:30%">
									<input type="text" id="CREDIT_TOTAL3" name="CREDIT_TOTAL" class="labelLine number"/>
								</td>
							</tr>
						</thead>
					</table>
