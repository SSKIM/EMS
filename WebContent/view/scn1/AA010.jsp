...
<html>
	...
	<body>
		...
		<table class="searchTable" id="searchTable1">
			<tr>
				<th style="width:120px"><div id="I002">전표번호</div></th>
				<td>
			...
			<div id="tab-1" class="tabs-selected">
				...
				<div class="main" style="height:92px">
					<table class="dataTable" id="deptTable1">
						...
						<thead>
							<tr>
								<th id="lblREMARK5">금액</th>
								<th class=hidden>부서코드</th><th id="lblREMARK6">부서명</th>
								<th class=hidden>채널코드</th><th id="lblREMARK7">채널명</th>
								<th class=hidden>자산코드</th><th id="lblREMARK8">자산명</th>
							</tr>
						</thead>
						<tbody>
